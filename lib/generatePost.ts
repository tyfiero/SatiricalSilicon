...
export const generatePost = async () =>{
    ...
    const selectionLLM = new ChatOpenAI({ temperature: 0.2 });
    ...
    console.log('pre overall chain')
    const blogPost = await overallChain.run("tech news, AI and programmer / developer stories");
    console.log('post overall chain')
