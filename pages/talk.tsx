...
function Talk() {
  ...
  return (
    <>
      <Head>
        <title>Talk</title>
        <meta name="description" content={`My talk for AI tinkerers`} />
      </Head>
      <div className="flex flex-col items-center page-container !px-0 !mb-0">
        <div className="w-full h-[120vh] px-20 py-20 ring-2 bg-gradient-to-br from-white to-p-300 flex flex-col justify-between">
          <MotionHeader>
            {titleClicked ? (
              ...
              >
                I Made a GPT-4 App that Pumps Out Satirical Fake News Articles
                that are Kinda Funny, Automatically!
              </m.h1>
            ) : (
              <m.h1
                initial={{ letterSpacing: "-0.1em" }}
          ...
          >
            {buttonClicked ? "Generating..." : "Make a post!"}
          </button>
        </div>
        ...
        <div className="w-full h-[120vh] px-20 py-20 ring-2 bg-gradient-to-br from-white to-p-50">
          ...
          <ol className="text-3xl leading-[4rem] f1 list-disc">
            <li>
              <strong>Writing and publishing blog posts is tedious</strong> -
              Why not automate all of it?
            </li>
            <li>
              {" "}
              <strong>Learning</strong> - I needed an excuse to learn Langchain,
              and be one of those 'cool' AI devs
            </li>
            <li>
              <strong>I love comedy</strong> - Especially satirical news like
              "The Onion"
            </li>
            <p className="ml-4 text-2xl">
              {" "}
              - Turns out GPT-4 is kinda good at satire{" "}
